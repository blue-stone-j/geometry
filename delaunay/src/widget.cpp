...
void Widget::mousePressEvent(QMouseEvent *e)
{
  ...
  if (drawTag == 0 && box.contains(e->pos( )))
  {
    ...
    myHull.generateVoronoi( );
    vpts   = myHull.getVoronoiPoints( );
    vlines = myHull.getVoronoiLines( );
    // update UI
    update( );
  }
}
    ...
    case 0: {
      ...
      switch (drawType)
      {
        ...
        case 2: {
          ...
          // delaunay三角形
        case 3: {
          if (!isShowColor) // delaunay三角形，无颜色填充
          {
        ...
        case 4: {
          ...
          {
            p.drawLine(QPointF(vlines[i].p1.x, vlines[i].p1.y), QPointF(vlines[i].p2.x, vlines[i].p2.y));
          }
          ...
          // {
          //   p.drawPoint(QPointF(vpts[i].x, vpts[i].y));
          // }
          break;
        }
      }
